# Hi, I'm Miklós Fazekas

## About Me

Senior Software Engineer with 20+ years of experience in mobile, web, and systems development. M.Sc. in Computer Science from Eötvös Loránd University. Currently serving as a maintainer of [@rnmapbox/maps](https://github.com/rnmapbox/maps), one of the most popular mapping libraries for React Native.
...
- **Backend & Systems** development with NodeJS/TypeScript (supabase), Ruby/Rails, Python
- **Architecture & Infrastructure** design for large-scale applications
- **Cross-platform Development** across mobile and desktop platforms

## Technical Expertise

- **Expert**: C++, Framework Design, Large Projects, Legacy Code
- **Advanced**: Ruby/Rails, Python, TCP/IP Programming, React Native
- **Intermediate**: Objective-C/iOS, Java, JavaScript/HTML/CSS, Expo
- **Specialized**: Multi-platform Development, Supabase
- **Infrastructure**: CI/CD, Build Systems, Unit Testing, Git

## Open Source Contributions

- **[@rnmapbox/maps](https://github.com/rnmapbox/maps) Maintainer**: Leading React Native mapping solutions
...
**M.Sc., Computer Science** - Eötvös Loránd University of Sciences *(1995-2000)*

## Connect With Me

- Portfolio: [mfazekas.szemafor.com](https://mfazekas.szemafor.com/cv.html)
- Open to collaboration on React Native, iOS, systems development projects, and [@rnmapbox/maps](https://github.com/rnmapbox/maps)
- Feel free to reach out for project discussions or contributions

---

*Passionate about building robust, scalable solutions and contributing to the open-source community.*